...
public class BestellingenMenu {
    ...
    @Autowired
    private BestelregelMenu bestelregelMenu;
    @Autowired
	 ...
	 * System.out.println("2: Annuleer"); int keuze = input.nextInt();
	 * switch(keuze){ case 1: pasPrijsAan(bestellingId); break; case 2:
	 * zoekBestelling(); break; default: System.out.println("Ongeldige keuze");
	 * pasBestellingAan(bestellingId); } }
	 * 
	 * public void pasPrijsAan(int bestellingId){
	 * System.out.println("Vul nieuwe prijs in"); BigDecimal prijs =
	 * input.nextBigDecimal(); if(bestellingController.pasPrijsAan(bestellingId,
	 * prijs)){ System.out.println("Prijs aangepast!"); } else{
	 * System.err.println("Prijs kon niet aangepast worden!"); } zoekBestelling(); }
     */
    ...
    /*
	 * public void printAlleBestellingen(){ for(String s :
	 * bestellingController.getAlleBestelling()){ System.out.println(s); } }
     */
}
